            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="sex" class="col-md-4 col-form-label text-md-end">性別</label><br>

                            <div class="col-md-6">
                                <label><input id="sex" type="radio" name="sex" value=0 {!! empty(old()) || old('example') == 0 ? 'checked="checked"' : '' !!}>男性</label><br>
                                <label><input id="sex" type="radio" name="sex" value=1 >女性</label><br>
                                @error('sex')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            <label for="height" class="col-md-4 col-form-label text-md-end">身長</label>
                        ...
                        <div class="row mb-3">
                            <label for="weight" class="col-md-4 col-form-label text-md-end">体重</label>
